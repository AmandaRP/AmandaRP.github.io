...
<!-- (Sometimes a slightly different rule of thumb is used: that *all* cell counts have an expected value of *at least* 5.)  -->  
...
Consider first the Fisher's exact test for the original train/test data:
