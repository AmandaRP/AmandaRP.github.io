...
[Psalms](https://www.biblegateway.com/quicksearch/?quicksearch=psalms&qs_version=GNT) is a book in both the Christian Bible and the Jewish Torah. I thought it would be interesting to look at a sentiment analysis of the book. I chose to work with the "Good New Translation" of the bible as it does not have copyright issues like some of the other translations (per the [American Bible Society](https://scripture.api.bible/)). We'll use the [tidytext](https://CRAN.R-project.org/package=tidytext) and [sentimentr](https://CRAN.R-project.org/package=sentimentr) R packages to do the analysis. Let's start by reading data from [biblegateway.com](https://www.biblegateway.com/) (using [rvest](https://CRAN.R-project.org/package=rvest)) and doing a bit of cleaning:
...
The [sentimentr GitHub page](https://github.com/trinker/sentimentr) also discusses  the equations used to calculate sentiment. With a bit of work we could apply similar valence shifters with the `tidytext` package, but it's nice that it's automated in `sentimentr`. 
...
Have comments or feedback? Message me on Twitter: [AmandaRPlunkett](https://twitter.com/AmandaRPlunkett)
