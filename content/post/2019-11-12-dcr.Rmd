...
1. [`ggplot2`](https://cran.r-project.org/web/packages/ggplot2/index.html) + [`sf`](https://cran.r-project.org/web/packages/sf/index.html) for bivariate plots: `ggplot2::geom_sf()`. See the [Drawing beautiful maps with R, sf, and ggplot2 sf](https://www.r-spatial.org/r/2018/10/25/ggplot2-sf.html)  tutorial
...
```{r echo=FALSE}
# All defaults
knitr::include_graphics("/home/rstudio/AmandaRP.github.io/spatialsearch.jpeg")
```
