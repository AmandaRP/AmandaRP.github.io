...
- Talk featured a [demo of `flexdashboard`](https://maloriejhughes.github.io/Dashboarding-Tutorial/). See more info about `flexdashboard` on [RStudio's website](https://rmarkdown.rstudio.com/flexdashboard/).  
...
- [`arulesViz`](https://cran.r-project.org › package=arulesViz) - for visualization of association rules
...
- BERT has 12 layers. 
- RBERT usable now (available on GitHub), but the Jon and __ are making it more user-friendly. Goal: On CRAN by end of 2019
...
<center>
![](/home/rstudio/AmandaRP.github.io/spatialsearch.jpeg)
</center>
...
- Be sue to catch his `#tidytuesday` screen casts [on YouTube](https://www.youtube.com/playlist?list=PLEtQC6FY-llkqIhZjI1TYkm4cV6WjobTC). 
- 10 tricks that people have liked from his screen casts:
...
- Slides available [here](https://github.com/chendaniely/rstatsdc_2019-python-r)
 


**Managing Your Cloud: Working with APIs**,
Marck Vaisman, [*@wahululu*](https://twitter.com/wahululu)
