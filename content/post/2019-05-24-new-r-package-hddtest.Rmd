...
Notice in the plot above that for `delta` in the range of abot 40 to 100, the p-value is large when the null hypothesis is true (blue curves) and small when the null hypothesis is false (red curves). So, our previous choice of `delta`=60 seems reasonable.
