...
The above test produced a significant p-value meaning that we would reject the null. However, the difference isn't very interesting. Instead, let's test that the differences are within some neighborhood, `delta`:
