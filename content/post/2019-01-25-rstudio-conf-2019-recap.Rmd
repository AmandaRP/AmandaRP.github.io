...
This year I attended the 2019 rstudio::conf in Austin, TX. 
1700+ attendees
...
* Write a book:
    ...
    + R [bookdown](https://cran.r-project.org/web/packages/bookdown/index.html) package. * Slides: [bit.ly/drob-rstudio-2019](https://www.dropbox.com/s/jk7216yr30ztpdp/DavidRobinson-RStudio-2019-old.pdf?dl=0)
