...
I had the pleasure of attending rstudio::conf 2019 (in Austin, TX), a two-day conference about all things R and RStudio. Over 1700 people attended the main conference, which consisted of three tracks (so my summary below is only a third of the conference talks). There were an additional two days of tutorials and a two-day hackathon, which I did not attend. The 2020 conference will be in San Francisco Jan 27-30. 

rstudio::conf (and also the yearly UseR! conference) is a great way to stay up to date on the latest and greatest R packages (there are currently 13K+ packages on CRAN) and to meet others excited about rstats. They also gave the most useful swag that I've ever received at a conference: a binder full fo R package cheat sheets! ... in addition to hex stickers and t-shirts. A big theme was using R in production; I found the talk about the use of [R at T-mobile](#production) interesting. I also found the [education](#education) talks useful as I am an adjunct professor of statistics where I teach R. 

Recorded videos of all talks are posted [here](https://resources.rstudio.com/rstudio-conf-2019). Additionally, links to slides can be found at [here](https://github.com/kbroman/RStudioConf2019Slides). And, check out the Twitter hashtag, #rstudioconf.
...
* Now available on [CRAN](https://cran.r-project.org/web/packages/rayshader/index.html).
* How to use:
...
* Motivation for [parsnip](https://cran.r-project.org/web/packages/parsnip/index.html): 
...
* funneljoin - R package for common A/B testing analyses. Available at  [github.com/datacamp/funneljoin](https://github.com/datacamp/funneljoin). 
...
* Wrote book: R Markdown the Definitive Guide (free online: [bookdown.org/yihui/rmarkdown](https://bookdown.org/yihui/rmarkdown/))
...
## My after-conference TODO list:

* Idea: An internal R slack channel (done)
* Check out [tidymodels](https://cran.r-project.org/web/packages/tidymodels/index.html) library.
